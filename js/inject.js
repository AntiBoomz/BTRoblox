(function() {
	...
	function TemplatesReady(templates) {
		if(typeof(angular) === "undefined") return;
		
		var modifiedTemplates = {}
		angular.module("pageTemplateApp").run(["$templateCache", ($templateCache) => {
	...
	function DocumentReady(settings, page, matches, templates) {
		...
		setTimeout(function() {
			if($.fn.linkify)
				$(".btr-post-angular-linkify").linkify()
		},50)
	}
